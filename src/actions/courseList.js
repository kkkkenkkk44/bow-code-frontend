export const FETCH_LIST_START = 'COURSE_FETCH_LIST';
export const FETCH_LIST_FINISH = 'COURSE_FETCH_LIST_FINISH';
export const DIFFICULTY_CHANGE = 'COURSE_DIFFICULTY_CHANGE';
export const CATEGORY_CHANGE = 'COURSE_CATEGORY_CHANGE';
export const TAGS_FILTER_CHANGE = 'COURSE_TAGS_FILTER_CHANGE';
export const CLICK_ALL_TAG = 'COURSE_CLICK_ALL_TAG'
export const KEYWORD_CHANGE = 'COURSE_KEYWORD_CHANGE'
